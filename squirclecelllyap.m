%
%squirclecelllyap computes the Lyapunov Exponent for Squircle Cell
%billiard tables
%

function limArr=squirclecelllyap(r,rho, derivComp,n,raw)
print("CALL SQUIRCLECELLLYAP") %TEMPORARY
